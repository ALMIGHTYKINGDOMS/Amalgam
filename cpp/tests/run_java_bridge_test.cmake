# Java bridge protocol test: compiles the version-independent bridge classes plus the
# test harness with the real JDK and runs it (no Gradle, no network).
if(NOT DEFINED ENV{AMALGAM_JAVAC} OR NOT DEFINED ENV{AMALGAM_JAVA})
    message(FATAL_ERROR "AMALGAM_JAVAC / AMALGAM_JAVA not set")
endif()

file(REAL_PATH "${CMAKE_CURRENT_LIST_DIR}/../../java/common/src/main/java/amalgam/bridge" COMMON_SRC)
file(REAL_PATH "${CMAKE_CURRENT_LIST_DIR}/../../java/common/src/test/java/amalgam/bridge" TEST_SRC)
set(OUT_DIR "${CMAKE_CURRENT_BINARY_DIR}/java_bridge_test")
file(REMOVE_RECURSE "${OUT_DIR}")
file(MAKE_DIRECTORY "${OUT_DIR}")

set(SOURCES
    "${COMMON_SRC}/Actions.java"
    "${COMMON_SRC}/Capabilities.java"
...
message(STATUS "java bridge test passed")
