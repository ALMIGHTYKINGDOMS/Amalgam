...
- [ ] External owner gates are unchanged: trusted Authenticode certificate, Microsoft/Xbox approval, publication/verification of the signed feed and website release, Supabase leaked-password protection, and clean-machine Java handoff. Bedrock remains runtime-excluded.
