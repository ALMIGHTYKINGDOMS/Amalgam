import { getPlayerSession, getState } from "./util/state.js";
...
export function connectionCapabilities(player) {
  ...
  return {
    ...
    serverMetadata: Boolean(session.serverName || session.serverAddress),
